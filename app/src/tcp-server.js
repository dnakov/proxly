...
(function(exports) {
  ...
  function TcpServer(addr, port, options) {
    ...
    // Callback functions.
    this.callbacks =  {
      recv: function(a) {console.log(a);},       // Called when client receives data from server.
      sent: function(a) {console.log(a);}        // Called when client sends data to server.
    };
  ...
  TcpServer.prototype._onAccept = function(resultInfo) {
    ...
    if (resultInfo.resultCode===0) {
      ...
      var tcpConnection = new TcpConnection(resultInfo.socketId, this.callbacks);
   ...
   */
  function TcpConnection(socketId, cbs) {
    ...
    this.callbacks.recv = function(a) {console.log(a);};
    this.callbacks.sent = function(a) {console.log(a);};
