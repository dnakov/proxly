...
(function() {
  var IMAGE_STYLES, Reloader, Timer, numberOfMatchingSegments, pathFromUrl, pathsMatch, pickBestMatch, splitUrl;
  ...
  Reloader = (function() {
    ...
    Reloader.prototype.reload = function(path, options) {
      ...
      if (((_ref = path.match(/\.([^\.]*css)/i)) != null ? _ref[1] : void 0) != null) {
        if (this.reloadStylesheet(path)) {
          return;
        }
      }
      if (((_ref1 = path.match(/\.[^\.]*(jpe?g|png|gif)/i)) != null ? _ref1[1] : void 0) != null) {
  ...
  window.LiveReload_ = window.LiveReload_ || (new Reloader(window, console, Timer));

  chrome.runtime.onMessage.addListener((function(_this) {
    return function(msg, sender, sendResponse) {
      if (msg.action === "reload") {
        return window.LiveReload_.reload(msg.path);
      }
    };
  })(this));
